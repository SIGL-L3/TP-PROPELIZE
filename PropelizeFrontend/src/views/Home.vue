      ...
      async loaddata(){
        try{
          ...
          if (token){
            ...
            this.carsdisplay = response.data
  ...
  <!--          <i class='bx  bx-search bx-sm'  style='color:#ffffff;cursor: pointer' @click="searchByRegistration"></i>-->
            ...
            <div id="group-user"><img src="../assets/images/community.png" width="50px" alt=""></div>
            <div id="group-user"><img style="filter: invert()" src="../assets/images/iconcar.png" width="40px" alt=""></div>
            <div style=" cursor: pointer" @click="handlinglogout" class="logout">logout</div>
          </div>
     </nav>
      <div class="car-container">
        <div @click="view_add=!view_add" class="btn-add">
          <p>+</p>
        </div>
